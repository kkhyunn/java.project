...
public class Ex05 {
	...
	// Stack(스택) : LIFO (Last In Fisrt Out) : 마지막에 들어온 데이터가 맨 처음에 나간다.
	// 주요 메소드
	...
	public static void main(String[] args) {
		...
		stack.add(1, "둘리"); // 삽입 (중복 가능)
		System.out.println(stack);
		System.out.println("==================");
		
		// 마지막에 들어온 객체 보기 pop(삭제 O), peek(삭제 X = for문 사용하면 무한루프)
		...
		// contains, indexcOf, search, get, elementAt, firstElement, lastElement
		...
		while (! stack.isEmpty()) {
			String k = stack.pop();
			System.out.println(k + " 삭제됨, 크기는 " + stack.size() + " 입니다.");
		}
	}
}
